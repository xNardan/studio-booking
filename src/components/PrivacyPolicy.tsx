    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-gray-accent/30 py-12">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p>
            Niniejsza Polityka Prywatności określa zasady gromadzenia, przetwarzania i wykorzystywania danych osobowych pozyskanych od Państwa przez Flow Studio, prowadzone przez FlowStudioBp, za pośrednictwem strony internetowej www.flowstudiobp.pl.
          </p>
          <p>
          ...
          <p>
            Administratorem Państwa danych osobowych jest Flow Studio, FlowStudioBp.
          </p>
