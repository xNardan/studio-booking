        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <h1 className="text-3xl font-bold flex items-center gap-2">
              <CalendarIcon className="text-primary" /> Lista Rezerwacji
            </h1>
                ...
                <TableBody>
                  {bookings.map((booking) => (
                    <TableRow key={booking.id} className="hover:bg-secondary/10 transition-colors">
                      ...
                      <TableCell>
                        <span className="capitalize bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-bold">
                          {booking.service}
                        </span>
                      </TableCell>
                      <TableCell>
                        <div className="flex flex-col gap-1 text-sm">
                          <a href={`mailto:${booking.customer_email}`} className="flex items-center gap-2 hover:text-primary transition-colors">
                            <Mail size={14} /> {booking.customer_email}
                          </a>
                          <a href={`tel:${booking.customer_phone}`} className="flex items-center gap-2 hover:text-primary transition-colors">
